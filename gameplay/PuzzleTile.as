package gameplay
{
   ...
   public class PuzzleTile implements IEventDispatcher
   {
      ...
      public function PuzzleTile(_nWorldX:Number, _nWorldY:Number, _oRoom:Room)
      {
         super();
         oRoom = _oRoom;
         ...
         GameDispatcher.Instance.addWeakEventListener(MovingBodyEvent.EVENT_PLAYER_MOVE,onPlayerMove,22);
      }
      ...
      {
         dispatchEvent(new MapGenerateEvent(MapGenerateEvent.EVENT_DESTROY_PUZZLE_NODE,this));
      ...
      private function onPlayerMove(_e:MovingBodyEvent) : void
      {
         ...
         {
            dispatchEvent(new RoomEvent(RoomEvent.EVENT_ROOM_PUZZLE_SOLVED,oRoom.getRoomId(),oWorldPos));
            trace("PUZZLE SOLVED");
            destroy();
         }
      }
