package gameplay
{
   ...
   public class Squidward extends StateManaged implements IEventDispatcher
   {
      ...
      public function Squidward(_mcRef:MovieClip, _oRoom:Room)
      {
         super(_mcRef);
         oRoom = _oRoom;
      ...
      {
         if(!Profile.Instance.isSquidwardNeedHelp())
         {
      ...
      private function addListeners() : void
      {
         ...
         oRoom.addEventListener(RoomEvent.EVENT_ROOM_CLEARED,onSquidwardHelp,false,0,true);
      ...
      private function removeListeners() : void
      {
         ...
         oRoom.removeEventListener(RoomEvent.EVENT_ROOM_CLEARED,onSquidwardHelp);
      ...
      private function onTalk(_e:PlayerEvent = null) : void
      {
         ...
         if(_bTalk)
         {
            Storyline.play("Squidward");
         }
      }
      
      private function onSquidwardHelp(_e:Event = null) : void
      {
         if(Profile.Instance.isSquidwardNeedHelp() && Profile.Instance.doHelpSquidward())
         {
            setState(sSTATE_IDLE2);
            Storyline.goto("Squidward","Saved");
      ...
      private function destroy(_e:GameEvent = null) : void
      {
         ...
         oWorldBody = null;
         mcRef = null;
         dispatchEvent(new MapGenerateEvent(MapGenerateEvent.EVENT_DESTROY_SQUIDWARD,this));
         oEventDisp = null;
      }
