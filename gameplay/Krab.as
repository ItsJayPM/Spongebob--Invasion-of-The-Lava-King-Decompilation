package gameplay
{
   ...
   public class Krab extends StateManaged implements IEventDispatcher
   {
      ...
      private static var sSTATE_IDLE3:String = "idle3";
      ...
      public function Krab(_mcRef:MovieClip, _oRoom:Room)
      {
         super(_mcRef);
         oRoom = _oRoom;
         ...
         addState(sSTATE_IDLE3,stateIdle);
         addListeners();
      ...
      private function destroy(_e:Event = null) : void
      {
         removeListeners();
         oWorldBody = null;
         oRoom = null;
         mcRef = null;
         dispatchEvent(new MapGenerateEvent(MapGenerateEvent.EVENT_DESTROY_KRAB,this));
         oEventDisp = null;
      }
